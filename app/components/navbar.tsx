        ...
        <div className="flex items-center justify-between">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="left" className="w-72 max-w-sm bg-white shadow-lg" style={{ backdropFilter: 'blur(4px)' }}>
              ...
              <nav className="flex flex-col mt-16 space-y-4 pt-4 text-black">
                <Link onClick={closeMenu} className="text-lg hover:opacity-70 border-b border-gray-400 pb-2" href="/"> Home       
                        {/* <div className="-mt-10">
                                 <Image
                ...
                <Link onClick={closeMenu} className="text-lg hover:opacity-70 border-b border-gray-400 pb-2" href="/howitworks">Get Yours Today</Link>
